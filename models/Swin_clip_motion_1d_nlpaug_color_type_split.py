...
class Swin_clip_motion_1d_nlpaug_color_type_split(nn.Module):
    def __init__(self, cfg_model):
        super(Swin_clip_motion_1d_nlpaug_color_type_split, self).__init__()
    ...
    def forward(self, x):
        ...
        if self.SPLIT_TEXT == True:
            ...
            # For Split text data
            features_text_fusion_s1 = self.fc_text_fusion(features_text_s1)
            features_text_obj_s1 = self.fc_text_obj(features_text_fusion_s1)
            features_text_motion_s1 = self.fc_text_motion(features_text_fusion_s1)

            features_text_fusion_s2 = self.fc_text_fusion(features_text_s2)
            features_text_obj_s2 = self.fc_text_obj(features_text_fusion_s2)
            features_text_motion_s2 = self.fc_text_motion(features_text_fusion_s2)

            features_text_fusion_s3 = self.fc_text_fusion(features_text_s3)
            features_text_obj_s3 = self.fc_text_obj(features_text_fusion_s3)
            features_text_motion_s3 = self.fc_text_motion(features_text_fusion_s3)
