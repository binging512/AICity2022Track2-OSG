...
class Baseline_motion_2d(nn.Module):
    def __init__(self, cfg_model):
        super(Baseline_motion_2d, self).__init__()
        self.encoder_motion = self.get_img_encoder()
    ...
    def forward(self, x):
        ...
        features_motion = self.encoder_motion(x['motion'])
